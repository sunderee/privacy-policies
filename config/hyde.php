...
return [
    ...
    */
    ...
    'name' => env('SITE_NAME', 'Peter Aleksander Bizjak s.p. | Privacy Policies'),
    ...
    */
    ...
    'rss' => [
        ...
        'description' => env('SITE_NAME', 'Privacy Policies').' RSS Feed',
    ],
    ...
    */
    ...
    'meta' => [
        ...
        Meta::name('description', 'HydePHP-based site built to host legalese information for applications developed under sole proprietorship company.'),
        Meta::name('generator', 'HydePHP v'.Hyde\Hyde::version()),
        Meta::property('site_name', env('SITE_NAME', 'Apps by Peter Aleksander Bizjak')),
    ],
    ...
    */
    ...
    'footer' => 'Site proudly built with ☕️ + ❤️ + 💪 + [HydePHP](https://github.com/hydephp/hyde)',
